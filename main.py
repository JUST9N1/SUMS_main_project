...
class Bill_App:
    ...
    def __init__(self, root):
        ...
        title = Label(self.root, text = "Welcome to SUMS food", bd = 12, relief = GROOVE, bg = bg_color, fg = "white", font = ("times new roman", 30, "bold",), pady = 2 ).pack( fill = X)
        #*****************************Variables****************
        #*****************************Items********************
        self.cake = IntVar()
        self.Burger = IntVar()
        ...
        F1 = LabelFrame(self.root,bd = 10, relief=GROOVE, text = "Customer Details", font = font, fg = "gold",bg = bg_color )
        F1.place(x= 0, y = 80, relwidth=1)

        cname_lbl = Label(F1, text= "Customer Name",bg =bg_color, fg= "white", font = font).grid(row = 0, column=0, padx=20, pady=5)
        cname_txt = Entry(F1, width=15,textvariable=self.c_name, font=("aerial", 15), bd = 7, relief = SUNKEN).grid(row=0, column=1, pady=5, padx=10)

        cphn_lbl = Label(F1, text="Phone No.", bg=bg_color, fg="white", font=font).grid(row=0, column=2, padx=20, pady=5)
        cphn_txt = Entry(F1, width=15,textvariable=self.c_phone, font=("aerial", 15), bd=7, relief=SUNKEN).grid(row=0, column=3, pady=5, padx=10)

        cbill_lbl = Label(F1, text="Bill Number", bg=bg_color, fg="white", font=font).grid(row=0, column=4, padx=20, pady=5)
        cbill_txt = Entry(F1, width=15,textvariable=self.search_bill, font=("aerial", 15), bd=7, relief=SUNKEN).grid(row=0, column=5, pady=5, padx=10)
        ...
        item7_txt = Entry(F2, width=10,textvariable=self.DrumStick, font=font, bd=5, relief=SUNKEN).grid(row=5, column=1, padx=10, pady=10)
        ...
        drink1_txt = Entry(F3, width=10,textvariable=self.Lassi, font= font, bd =5, relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10)
        ...
        bath_txt = Entry(F4, width=10,textvariable=self.Largepizza, font=font, bd=5, relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10)

        bath_lbl = Label(F4, text="french fries", font=font, bg=bg_color, fg="lightgreen").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        bath_txt = Entry(F4, width=10,textvariable=self.FrenchFries, font=font, bd=5, relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10)

        bath_lbl = Label(F4, text="hot chillies", font=font, bg=bg_color, fg="lightgreen").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        bath_txt = Entry(F4, width=10,textvariable=self.Hotchillies, font=font, bd=5, relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10)

        bath_lbl = Label(F4, text="frozenMo", font=font, bg=bg_color, fg="lightgreen").grid(row=3, column=0, padx=10, pady=10, sticky="w")
        bath_txt = Entry(F4, width=10,textvariable=self.FrozenMo, font=font, bd=5, relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10)
        ...
        bath_txt = Entry(F4, width=10,textvariable=self.Lightwine, font=font, bd=5, relief=SUNKEN).grid(row=5, column=1, padx=10, pady=10)

        #********************* Bill Area ********************
        F5 = LabelFrame(self.root, bd=10,bg = bg_color, relief=GROOVE)
        F5.place(x=815, y=180,width=532, height=375)
        bill_title = Label(F5, text = "Bill Area", font = ("aerial", 16, "bold"), bd = 7, relief= GROOVE).pack(fill=X)
        ...
        F6 = LabelFrame(self.root, bd=10, relief=GROOVE, text="Bill Menu", font=font, fg="gold", bg=bg_color)
        F6.place(x= 0, y=560, relwidth=1, height= 140)

        m1 = Label(F6, text = "Total Items Price",bg= bg_color, fg="white", font = ("times new roman", 14, "bold")).grid(row= 0, column=0, padx=20, pady=1, sticky="w")
        m1_txt = Entry(F6, width=18,textvariable=self.Items_Price, font= ("aerial", 10, "bold"), bd = 7, relief= SUNKEN).grid(row=0, column=1, padx=10, pady=1)

        m2 = Label(F6, text="Total Drinks Price", bg=bg_color, fg="white", font=("times new roman", 14, "bold")).grid(row=1, column=0, padx=20, pady=1, sticky="w")
        m2_txt = Entry(F6, width=18,textvariable=self.Drinks_Price, font=("aerial", 10, "bold"), bd=7, relief=SUNKEN).grid(row=1, column=1, padx=10,pady=1)

        m3 = Label(F6, text = "Total Specials price",bg= bg_color, fg="white", font = ("times new roman", 14, "bold")).grid(row= 2, column=0, padx=20, pady=1, sticky="w")
        m3_txt = Entry(F6, width=18,textvariable=self.Specials_Price, font= ("aerial", 10, "bold"), bd = 7, relief= SUNKEN).grid(row=2, column=1, padx=10, pady=1)

        c1 = Label(F6, text="Items Tax", bg=bg_color, fg="white", font=("times new roman", 14, "bold")).grid(row=0, column=2, padx=20, pady=1, sticky="w")
        c1_txt = Entry(F6, width=18,textvariable=self.Items_Tax, font=("aerial", 10, "bold"), bd=7, relief=SUNKEN).grid(row=0, column=3, padx=10,pady=1)

        c2 = Label(F6, text="Drinks Tax", bg=bg_color, fg="white", font=("times new roman", 14, "bold")).grid(row=1, column=2, padx=20, pady=1, sticky="w")
        c2_txt = Entry(F6, width=18,textvariable=self.Drinks_Tax, font=("aerial", 10, "bold"), bd=7, relief=SUNKEN).grid(row=1, column=3, padx=10,pady=1)

        c3 = Label(F6, text="Specials Tax", bg=bg_color, fg="white", font=("times new roman", 14, "bold")).grid(row=2, column=2, padx=20, pady=1, sticky="w")
        c3_txt = Entry(F6, width=18,textvariable=self.Specials_Tax, font=("aerial", 10, "bold"), bd=7, relief=SUNKEN).grid(row=2, column=3, padx=10,pady=1)

        btn_F = Frame(F6, bd= 7, relief=GROOVE)
        btn_F.place(x = 730, width= 585, height=105)


        total_btn = Button(btn_F, text="Total", bg= "cadetblue", fg="white",bd = 2,  pady = 15, width=10, font= font, command=self.total).grid(row=0, column=0, padx=5, pady=5)
        GBill_btn = Button(btn_F, text="Generate Bill",command=self.bill_area, bg= "cadetblue", fg="white",bd = 2,  pady = 15, width=10, font= font).grid(row=0, column=1, padx=5, pady=5)
        Clear_btn = Button(btn_F, text="Clear",command=self.clear_data, bg= "cadetblue", fg="white",bd = 2,  pady = 15, width=10, font= font).grid(row=0, column=2, padx=5, pady=5)
        Exit_btn = Button(btn_F, text="Exit", command=self.Exit_app ,bg= "cadetblue", fg="white",bd = 2,  pady = 15, width=10, font= font).grid(row=0, column=3, padx=5, pady=5)
        self.welcome_bill()
